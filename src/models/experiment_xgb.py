...
def run_xgb_experiments(X_train, y_train, X_test, y_test):
    ...
    for name, sampler in samplers.items():
        ...
        with mlflow.start_run(run_name=f"xgb_{name}"):
    ...
    print("✅ XGB Experiments Completed")
...
if __name__ == "__main__":
    ...
    run_xgb_experiments(X_train, y_train, X_test, y_test)